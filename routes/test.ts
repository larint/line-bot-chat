...
router.get('/', async (req, res, next) => {
	...
	res.render('test', { title: 'Test', auth: auth });
	...
	result.messageDeliveries = <lineTypes.NumberOfMessageDeliveries>await client.getNumberOfMessageDeliveries(req.params.date)
